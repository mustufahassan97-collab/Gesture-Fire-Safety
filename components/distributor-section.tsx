...
export function DistributorSection() {
  ...
  return (
    <section
      id="where-to-buy"
      className="py-24 bg-secondary border-t border-border relative overflow-hidden"
      ref={ref}
    >
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-3 gap-8 items-stretch">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              className="lg:col-span-1 glass p-8 rounded-3xl flex flex-col items-center justify-center border border-border group hover:border-primary/30 transition-all duration-500"
            >
              <Image
                ...
                width={200}
                height={200}
                className="w-full max-w-[200px] h-auto object-contain brightness-110"
              />
            ...
            <motion.div
              ...
              className="lg:col-span-2 glass p-10 rounded-3xl border border-white/10 group hover:border-primary/30 transition-all duration-500 relative overflow-hidden"
            >
              <div className="flex flex-col md:flex-row gap-10">
                {/* Left: Basic Info */}
                <div className="flex-1">
                  <h4 className="text-3xl font-black uppercase text-white mb-1">
                ...
                <div className="md:w-64 flex flex-col gap-3">
                  <div className="glass p-4 rounded-xl border border-border bg-white/5">
                    ...
                    <Link
                      ...
                      className="text-white text-xs font-bold hover:text-primary transition"
                    >
              ...
              {/* Action Button */}
              <div className="mt-8 pt-6 border-t border-border flex justify-center md:justify-start">
                <Link
                  href="tel:+923368088002"
                  className="bg-white text-black px-10 py-4 font-black uppercase text-[10px] hover:bg-primary hover:text-white transition-all duration-500 shadow-xl group-hover:scale-105"
                >
                  Contact Distributor
                </Link>
              </div>
